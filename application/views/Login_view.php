...
body {
    ...
    text-align: center;
    height: 100%;
    background: -moz-linear-gradient(270deg, rgba(255,20,147) 0%, rgba(81,195,184,1) 100%);
    background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, rgba(255,20,147)), color-stop(100%, rgba(81,195,184,1)));
    background: -webkit-linear-gradient(270deg, rgba(255,20,147) 0%, rgba(81,195,184,1) 100%);
    background: linear-gradient(180deg, rgba(255,20,147) 0%, rgba(81,195,184,1) 100%);
    overflow:hidden;
}
